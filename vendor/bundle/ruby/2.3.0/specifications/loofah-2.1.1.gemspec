...
Gem::Specification.new do |s|
  ...
  s.extra_rdoc_files = ["CHANGELOG.md", "MIT-LICENSE.txt", "Manifest.txt", "README.rdoc"]
  s.files = ["CHANGELOG.md", "MIT-LICENSE.txt", "Manifest.txt", "README.rdoc"]
  ...
  if s.respond_to? :specification_version then
    ...
    if Gem::Version.new(Gem::VERSION) >= Gem::Version.new('1.2.0') then
      ...
      s.add_development_dependency(%q<concourse>, [">= 0.14.0"])
      ...
      s.add_dependency(%q<concourse>, [">= 0.14.0"])
